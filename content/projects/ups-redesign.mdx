...
image: ups-app-mockup-cover.jpg
year: 2022-04-01
playground: true
...
collaborators:
  - name: Alice
    ...
    avatar: /images/projects/ups-redesign/alice.png
links:
  - title: Prototype
...
<Image 
    src={`/images/projects/ups-redesign/ups-app-mockup-holding.jpg`}
...
<Image 
    src={`/images/projects/ups-redesign/ups-mockup-sender-payment.jpg`}
    alt={`Redesigned UPS Screens`}
    width={3200}
    height={2400}
/>
...
<Image 
    src={`/images/projects/ups-redesign/ups-mockup-shipping-label-scan-package.jpg`}
    alt={`Redesigned UPS Screens`}
    width={3200}
    height={2400}
/>